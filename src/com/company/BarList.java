...
public class BarList {
    ...
    private void buildAndPrintMap(double lat, double lon, String[][] map){
        ...
        for (Bar bar : this.bars) {
            ...
            if (bar.getLatitude() > lat && bar.getLongitude() > lon) {
                ...
                stringBuilder.append(count).append(". ").append(bar.getName()).append(" - ").append(bar.distanceInMetersToBar(lat, lon)).append(" \n");
                count++;
